<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StoricoRegistrazionePage.aspx.vb"
    Inherits="StoricoRegistrazionePage" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%--SPDX-License-Identifier: GPL-3.0-only--%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Ricerca Storico Registrazione</title>
                                    ...
                                    <table class="ContainerWrapper" border="0" cellpadding="2" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="background-color: #BFDBFF; padding: 4px; border-bottom: 1px solid  #9ABBE8;
                                                ...
                                                &nbsp;<asp:Label ID="ElencoRegistrazioniLabel" runat="server" Font-Bold="True" Style="width: 700px;
                                                    color: #00156E; background-color: #BFDBFF" Text="Elenco Storico Registrazioni" />
                                            </td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <td>
                                                            <div style="overflow: auto; height: 430px; width: 100%; background-color: #FFFFFF;
                                                                ...
                                                                <telerik:RadGrid ID="ProtocolliGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                    CellSpacing="0" GridLines="None" Skin="Office2007" Width="900px" AllowSorting="True">
                                                                    <MasterTableView DataKeyNames="Id">
                                                                        <Columns>
                                                                            <telerik:GridBoundColumn DataField="Id" DataType="System.Int32" FilterControlAltText="Filter Id column"
                                                                                HeaderText="Id" ReadOnly="True" SortExpression="Id" UniqueName="Id" Visible="False" />
                                                                            <telerik:GridTemplateColumn SortExpression="DataOraRegistrazione" UniqueName="DataOraRegistrazione"
                                                                                HeaderText="Data Modifica" DataField="DataOraRegistrazione" HeaderStyle-Width="110px"
                                                                                ItemStyle-Width="110px">
                                                                                <ItemTemplate>
                                                                                    <div title='<%# Eval("DataOraRegistrazione")%>' style="white-space: nowrap; overflow: hidden;
                                                                                        text-overflow: ellipsis; width: 110px;">
                                                                                        <%# Eval("DataOraRegistrazione")%></div>
                                                                                </ItemTemplate>
                                                                            </telerik:GridTemplateColumn>
                                                                            <telerik:GridTemplateColumn SortExpression="UtenteUsername" UniqueName="UtenteUsername"
                                                                                HeaderText="Utente Modifica" DataField="UtenteUsername" HeaderStyle-Width="160px"
                                                                                ItemStyle-Width="160px">
                                                                                <ItemTemplate>
                                                                                    <div title='<%# Eval("UtenteUsername")%>' style="white-space: nowrap; overflow: hidden;
                                                                                        text-overflow: ellipsis; width: 160px;">
                                                                                        <%# Eval("UtenteUsername")%></div>
                                                                                </ItemTemplate>
                                                                            </telerik:GridTemplateColumn>
                                                                            <telerik:GridTemplateColumn SortExpression="Oggetto" UniqueName="Oggetto" HeaderText="Oggetto"
                                                                                DataField="Oggetto" HeaderStyle-Width="160px" ItemStyle-Width="160px">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <telerik:GridTemplateColumn SortExpression="ElencoReferentiEsterni" UniqueName="ElencoReferentiEsterni"
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <div title='<%# Eval("ElencoReferentiEsterni")%>' style="white-space: nowrap; overflow: hidden;
                                                                            ...
                                                                            <telerik:GridTemplateColumn SortExpression="ElencoReferentiInterni" UniqueName="ElencoReferentiInterni"
                                                                                ...
                                                                                ItemStyle-Width="180px">
                                                                                <ItemTemplate>
                                                                                    <div title='<%# Eval("ElencoReferentiInterni")%>' style="white-space: nowrap; overflow: hidden;
                                                                                        text-overflow: ellipsis; width: 180px;">
                                                                ...
                                                                <table style="width: 900px; border: 1px solid #5D8CC9">
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <telerik:RadTabStrip runat="server" ID="DatiProtocolloTabStrip" SelectedIndex="5"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:ImageButton ID="AggiornaUtenteImageButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                                                                    Style="display: none" />
                                                                                                                <telerik:RadTextBox ID="IdUtenteEmergenzaTextBox" runat="server" Skin="Office2007"
                                                                                                            ...
                                                                                                            <table style="width: 100%">
                                                                                                                <tr>
                                                                                                                    <td style="width: 120px">
                                                                                                                        ...
                                                                                                                        <asp:Label ID="Label2" runat="server" Style="display: none" CssClass="Etichetta"
                                                                                                                            Text="Mittenti" AccessKey="1" AssociatedControlID="TrovaPrimoReferenteInternoImageButton" />
                                                                                                                    </td>
                                                                                                                    <td align="right">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="vertical-align: top; width: 70%">
                                                                                                <table style="width: 100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="right" style="width: 60px">
                                                                                                                        <asp:ImageButton ID="AggiornaSecondoReferenteInternoImageButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                                                                            Style="display: none" />
                                                                                                                        <asp:ImageButton ID="secondoReferenteInternoChechedButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                                                                            Style="display: none; width: 0px" />
                                                                                                                        <asp:ImageButton ID="secondoReferenteInternoIterChechedButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                                                                            Style="display: none; width: 0px" />
                                                                                                                        <telerik:RadTextBox ID="IdReferenteInternoTextBox" runat="server" Skin="Office2007"
                                                                                                                            Style="display: none" Width="0px" />
                                                                                                                        <asp:ImageButton ID="TrovaSecondoReferenteInternoImageButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                                                                            ToolTip="Seleziona referente interno (ALT+2) ..." />
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <div style="overflow: auto; height: 125px; border: 1px solid #5D8CC9">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <telerik:RadTextBox ID="OggettoTextBox" runat="server" MaxLength="500" Rows="7" Skin="Office2007"
                                                                                                                TextMode="MultiLine" Width="350px" ToolTip="Digitare parola chiave (INVIO)" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td style="height: 20px">
                                                                                                                <table style="width: 100%">
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            &nbsp;&nbsp;<asp:Label ID="NoteInterneLabel" Style="color: #00156E" Font-Bold="True"
                                                                                                                                runat="server" CssClass="Etichetta" Text="Note Interne" />
                                                                                                                        </td>
                                                                                                                        <td align="right">
