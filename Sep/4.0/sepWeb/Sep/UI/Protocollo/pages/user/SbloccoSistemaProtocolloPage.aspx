<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false"
    CodeFile="SbloccoSistemaProtocolloPage.aspx.vb" Inherits="SbloccoSistemaProtocolloPage" %>
                                            ...
                                            <table class="Container" cellpadding="0" cellspacing="4" width="100%" border="0">
                                                <tr>
                                                    <td align="center" style="height: 60px">
                                                        <asp:Label ID="MessaggioLabel" runat="server" Text="Attenzione: dopo la pressione del tasto OK verrà RIATTIVATO il servizio<br> di protocollazione, consentendo l'inserimento di nuove registrazioni."
                                                            Font-Size="Medium" />
                                                    </td>
                                                </tr>
                                                <tr class="GridFooter">
                                                    <td align="center" colspan="1">
                                                        <telerik:RadButton ID="SalvaButton" runat="server" Text="Ok" Width="80px" Skin="Office2007"
                                                            ToolTip="Sblocca servizio protocollazione">
