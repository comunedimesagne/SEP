<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false"
    CodeFile="StampaEtichettePage.aspx.vb" Inherits="StampaEtichettePage" %>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <telerik:RadListBox ID="TipoRicezioneInvioListBox" runat="server" Skin="Office2007"
                                                                                    Style="width: 600px; height: 100px" Height="100px" SortCaseSensitive="False"
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            <td>
                                                                                <table style="width: 100%; background-color: #BFDBFF">
                                                                                    <tr>
                                                                                        <td>
                                                                                            &nbsp;<asp:Label ID="ElencoRegistrazioniPartenzaLabel" runat="server" Font-Bold="True"
                                                                                                Style="width: 400px; color: #00156E; background-color: #BFDBFF" Text="Elenco Etichette Partenza" />
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:CheckBox ID="SelezionaTuttoProtocolliCheckBox" runat="server" Text="Seleziona tutto"
                                                                                                AutoPostBack="True" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <telerik:RadListBox ID="EtichetteListBox" runat="server" Skin="Office2007" Style="width: 600px;
                                                                                    height: 260px" Height="260px" SortCaseSensitive="False" Sort="Ascending" CheckBoxes="True"
