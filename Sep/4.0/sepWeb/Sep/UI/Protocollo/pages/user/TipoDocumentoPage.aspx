<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false"
    CodeFile="TipoDocumentoPage.aspx.vb" Inherits="TipoDocumentoPage" %>
                            ...
                            <table style="width: 100%; background-color: #BFDBFF; border: 1 solid #5D8CC9">
                                <tr>
                                    <td style="height: 20px">
                                        &nbsp;<asp:Label ID="TitoloElencoTipiDocumentoLabel" runat="server" Font-Bold="True"
                                            Style="width: 800px; color: #00156E; background-color: #BFDBFF" Text="Elenco tipi documento" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div style="overflow: auto; height: 320px; width: 100%; background-color: #FFFFFF;
                                            ...
                                            <telerik:RadGrid ID="TipiDocumentoGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                CellSpacing="0" GridLines="None" Skin="Office2007" Width="99.8%" AllowSorting="True"
                                                Culture="it-IT" PageSize="10">
