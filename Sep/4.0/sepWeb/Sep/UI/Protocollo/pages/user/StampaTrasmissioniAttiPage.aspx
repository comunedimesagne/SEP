<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false"
    CodeFile="StampaTrasmissioniAttiPage.aspx.vb" Inherits="StampaTrasmissioniAttiPage" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" style="width: 30px">
                                                        <asp:ImageButton ID="FiltraImageButton" runat="server" ImageUrl="~/images//search.png"
                                                            ToolTip="Filtra registrazioni" Style="border: 0" ImageAlign="AbsMiddle" />
                                                    </td>
                                                    <td align="center" style="width: 30px">
                                                ...
                                                <tr style="background-color: #DFE8F6">
                                                    <td valign="top">
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td style="width: 130px">
                                                                    <asp:Label ID="ReferenteLabel" runat="server" CssClass="Etichetta" Text="Referente" />
                                                                </td>
                                                                <td>
                                                                    <telerik:RadTextBox ID="ReferenteTextBox" runat="server" Skin="Office2007" Width="380px"
                                                                        Enabled="False" />&nbsp;
                                                                    <asp:ImageButton ID="TrovaReferenteImageButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                        ToolTip="Seleziona referente (ALT + S)..." />&nbsp;
                                                                    <asp:ImageButton ID="EliminaReferenteImageButton" runat="server" ImageUrl="~/images//RecycleEmpty.png"
                                                                        ToolTip="Cancella referente" />
                                                                    <asp:ImageButton ID="AggiornaReferenteImageButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                                        Style="display: none" />
                                                                    <telerik:RadTextBox ID="IdReferenteTextBox" runat="server" Skin="Office2007" Width="0px"
                                                                        Style="display: none" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td style="width: 130px">
                                                                    <asp:Label ID="StrutturaCompletaLabel" runat="server" CssClass="Etichetta" Text="Struttura completa" />
                                                                </td>
                                                                <td>
                                                                    <asp:CheckBox ID="StrutturaCompletaCheckBox" runat="server" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <table style="width: 100%">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <telerik:RadListBox ID="RegistrazioniListBox" runat="server" Skin="Office2007" Style="width: 600px;
                                                                                    height: 360px" Height="360px" SortCaseSensitive="False" Sort="Ascending" CheckBoxes="True"
