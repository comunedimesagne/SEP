<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false" CodeFile="TipologieReferentePage.aspx.vb" Inherits="TipologieReferentePage" %>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="DescrizioneTextBox" runat="server" Skin="Office2007" 
                            Width="600px" MaxLength="100" ToolTip="Descrizione Tipologia" />
                    </td>
                </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    &nbsp;<asp:Label ID="TitoloElencoLabel" runat="server" Font-Bold="True" Style="width: 800px;
                                                        color: #00156E; background-color: #BFDBFF" Text="Elenco Tipologie Referente" 
                                                        CssClass="Etichetta" />
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow: auto; height: 305px; width: 100%; background-color: #FFFFFF;
                                         ...
                                         <telerik:RadGrid ID="TipologieReferenteGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                ...
                                                <MasterTableView DataKeyNames="Id">
                                                    <Columns>
                                                        ...
                                                        <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" HeaderStyle-Width="20px"
                                                            ItemStyle-Width="20px" Text="Seleziona Tipologia Referente" FilterControlAltText="Filter Select column"
