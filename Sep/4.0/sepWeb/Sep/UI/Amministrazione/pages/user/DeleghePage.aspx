<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false"
    CodeFile="DeleghePage.aspx.vb" Inherits="DeleghePage" %>
                            ...
                            <div id="PannelloDettaglio" runat="server" style="padding: 2px 2px 2px 2px;">
                              ...
                              <table style="width: 100%; background-color: #DFE8F6; border: 1px solid #5D8CC9">
                                    <tr style="height: 30px">
                                        <td style="width: 90px">
                                            <asp:Label ID="DeleganteLabel" runat="server" CssClass="Etichetta" ForeColor="#FF6600"
                                                Text="Delegante *" />
                                        </td>
                                        <td style="width: 500px">
                                            <%--<telerik:RadTextBox ID="DeleganteTextBox" runat="server" Skin="Office2007" Width="500px"
                                                Enabled="False" ToolTip="Utente Delegante" />--%>
                               ...
                               ShowMoreResultsBox="true" EnableVirtualScrolling="true" Filter="StartsWith" ToolTip="Utente Delegante" Skin="Office2007"  AutoPostBack="true"  LoadingMessage="Caricamento in corso...">
                                <WebServiceSettings Method="GetUtenti" Path="DeleghePage.aspx"   />
                                        ...
                                        <td style="width: 25px; text-align: center">
                                            <asp:ImageButton ID="TrovaDeleganteImageButton" runat="server" ImageUrl="~/images//knob-search16.png"
                                                ToolTip="Seleziona delegante..." ImageAlign="AbsMiddle" Visible="false" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="EliminaDeleganteImageButton" runat="server" ImageUrl="~/images//RecycleEmpty.png"
                                                ToolTip="Cancella delegante" ImageAlign="AbsMiddle" Visible="false" />
                                           
                                            <asp:ImageButton ID="AggiornaDeleganteImageButton" runat="server" Style="display: none" />
                                           
                                           <%-- <asp:TextBox ID="IdDeleganteTextBox" runat="server" Style="display: none" />--%>
                                        </td>
                                    </tr>
                                                                        ...
                                                                        <td>
                                                                            <div id="scrollPanelProposte" style="overflow: auto; height: 200px; width: auto;
                                                                                ...
                                                                                <telerik:RadGrid ID="UtentiGridView" runat="server" AutoGenerateColumns="False" CellSpacing="0"
                                                                                    GridLines="None" Skin="Office2007" Width="99.8%" AllowSorting="False" AllowMultiRowSelection="true"
                                                                                    Culture="it-IT">
                                                                                    <ClientSettings>
                                                                ...
                                                                <table style="width: 100%">
                                                                    <tr>
                                                                        <td style="width:120px">
                                                                            &nbsp;<asp:Label ID="ElencoDelegatiLabel" runat="server" Style="color: #00156E" Font-Bold="True"
                                                                                Text="Delegati" />
                                                                        </td>
                                                                        <td>
                                                                            <table style="width: 100%">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div id="scrollPanelDeleganti" style="overflow: auto; height: 200px; width: 100%;
                                                                                background-color: #FFFFFF; border-top: 1px solid #5D8CC9;">
                                                                                <telerik:RadGrid ID="DelegatiGridView" runat="server" AutoGenerateColumns="False"
                                                                                    CellSpacing="0" GridLines="None" Skin="Office2007" Width="99.8%" AllowSorting="False"
                                                                                    AllowMultiRowSelection="true" Culture="it-IT">
                                                                                    ...
                                                                                    <MasterTableView DataKeyNames="Id" TableLayout="Fixed">
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <telerik:GridTemplateColumn UniqueName="CheckBoxIterTemplateColumn" HeaderText="Disabil."
                                                                                                HeaderStyle-Width="55px" ItemStyle-Width="55px" HeaderStyle-HorizontalAlign="Center"
                                                                                                ItemStyle-HorizontalAlign="Center" HeaderTooltip="Seleziona per disabilitare l'accesso sulla scrivania del delegante">
                                                                                                <ItemTemplate>
                                                                                                    <asp:CheckBox ID="DisabilitaAccessoScrivaniaCheckBox" runat="server" AutoPostBack="False"
                                                                                                        ToolTip="Seleziona per disabilitare l'accesso sulla scrivania del delegante" /></ItemTemplate>
                                                                                            </telerik:GridTemplateColumn>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width: 100%; background-color: #BFDBFF">
                                                <tr>
                                                    <td>
                                                        &nbsp;<asp:Label ID="TitoloElencoDelegantiLabel" runat="server" Font-Bold="True"
                                                            Style="width: 800px; color: #00156E; background-color: #BFDBFF" Text="Elenco Deleganti" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="overflow: auto; height: 305px; width: 100%; background-color: #FFFFFF;
                                                ...
                                                <telerik:RadGrid ID="DelegantiGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    ...
                                                    <MasterTableView DataKeyNames="Id">
                                                        <Columns>
                                                            <telerik:GridBoundColumn DataField="Id" DataType="System.Int32" FilterControlAltText="Filter Id column"
                                                                HeaderText="Id" Visible="false" SortExpression="Id" UniqueName="Id" />
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="825px" ItemStyle-Width="825px" DataField="Delegante"
                                                                FilterControlAltText="Filter Delegante column" HeaderText="Nominativo" SortExpression="Delegante"
                                                                AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" FilterControlWidth="100%"
                                                                ShowFilterIcon="False" UniqueName="Delegante">
                                                                <ItemTemplate>
                                                                    <div title='<%# Eval("Delegante")%>' style="white-space: nowrap; overflow: hidden;
                                                            ...
                                                            <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" HeaderStyle-Width="20px"
                                                                Text="Seleziona Delegante" ItemStyle-Width="20px" FilterControlAltText="Filter Select column"
