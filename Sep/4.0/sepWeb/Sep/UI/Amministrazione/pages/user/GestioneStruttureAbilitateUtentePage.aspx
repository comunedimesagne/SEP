<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false"
    CodeFile="GestioneStruttureAbilitateUtentePage.aspx.vb" Inherits="GestioneStruttureAbilitateUtentePage" %>
                                ...
                                <tr>
                                    <td>
                                        <telerik:RadToolBar ID="RadToolBar" runat="server" Skin="Office2007" Width="100%">
                                            <Items>
                                                <telerik:RadToolBarButton runat="server" ImageUrl="~/images/new.png" Text="Nuovo" Enabled="false"
                                                    CommandName="Nuovo" Owner="RadToolBar" />
                                                <telerik:RadToolBarButton runat="server" ImageUrl="~/images/Searchb.png" Text="Trova" Enabled="false"
                                                ...
                                                <telerik:RadToolBarButton runat="server" ImageUrl="~/images/Trashcanempty.png" Text="Elimina" Enabled="false"
                                                    CommandName="Elimina" Owner="RadToolBar" />
                                                <telerik:RadToolBarButton runat="server" ImageUrl="~/images/Printer.png" Text="Stampa" Enabled="false"
                           ...
                           <asp:HiddenField ID="CodiceStrutturaHidden" runat="server" />
                            ...
                            <table style="width: 100%; background-color: #BFDBFF; border: 1px solid #5D8CC9">
                                ...
                                <tr>
                                    <td>
                                     <div id="ZoneID1">
                                        <div id="scrollPanel" runat="server" style="overflow: auto; height: 300px; border: 1px solid #5D8CC9;
                                            ...
                                            <telerik:RadGrid ID="UtentiGridView" ToolTip="Elenco utenti" runat="server" AllowPaging="False"
                                                ...
                                                <MasterTableView DataKeyNames="IdUtente,Id">
                                                    <Columns>
                                                        ...
                                                        <telerik:GridTemplateColumn SortExpression="DescrizioneUtente" UniqueName="DescrizioneUtente"
                                                            HeaderText="Nominativo" DataField="DescrizioneUtente" HeaderStyle-Width="600px"
                                                         ...
                                                         <telerik:GridTemplateColumn SortExpression="DescrizioneModulo" UniqueName="DescrizioneModulo"
                                                            HeaderText="Modulo" DataField="DescrizioneModulo" HeaderStyle-Width="130px"
                                                            ItemStyle-Width="130px">
                                                            <ItemTemplate>
                                                                <div title='<%# Eval("DescrizioneModulo")%>' style="white-space: nowrap; overflow: hidden;
                                                                    text-overflow: ellipsis; width: 130px; border: 0px solid red">
                                                                    <%# Eval("DescrizioneModulo")%></div>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width: 100%; background-color: #BFDBFF">
                                                <tr>
                                                    <td>
                                                        &nbsp;<asp:Label ID="TitoloElencoStruttureLabel" runat="server" 
                                                            Font-Bold="True" Style="width: 800px;
                                                             color: #00156E; background-color: #BFDBFF" Text="Elenco Strutture" 
                                                            CssClass="Etichetta" />
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="overflow: auto; height: 335px; width: 100%; background-color: #FFFFFF;
                                                ...
                                                <telerik:RadGrid ID="StruttureGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    ...
                                                    <MasterTableView DataKeyNames="Id, Codice">
                                                        <Columns>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="300px" ItemStyle-Width="300px" DataField="DescrizioneGruppo"
                                                                FilterControlAltText="Filter DescrizioneGruppo column" HeaderText="Gruppo" SortExpression="DescrizioneGruppo"
                                                                ShowFilterIcon="False"
                                                                AutoPostBackOnFilter="True" FilterControlWidth="100%" AndCurrentFilterFunction="Contains"
                                                                UniqueName="DescrizioneGruppo">
                                                                <ItemTemplate>
                                                                    <div title='<%# Eval("DescrizioneGruppo")%>' style="white-space: nowrap;
                                                                        overflow: hidden; text-overflow: ellipsis; width:300px; border: 0px solid red">
                                                                        <%# Eval("DescrizioneGruppo")%></div>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>

                                                            <telerik:GridTemplateColumn HeaderStyle-Width="75px" ItemStyle-Width="75px" DataField="DescrizioneLivello"
                                                                FilterControlAltText="Filter DescrizioneLivello column" HeaderText="Tipologia" SortExpression="DescrizioneLivello"
                                                                ShowFilterIcon="False"
                                                                AutoPostBackOnFilter="True" FilterControlWidth="100%" AndCurrentFilterFunction="Contains"
                                                                UniqueName="DescrizioneLivello">
                                                                <ItemTemplate>
                                                                    <div title='<%# Eval("DescrizioneLivello")%>' style="white-space: nowrap;
                                                                        overflow: hidden; text-overflow: ellipsis; width: 75px; border: 0px solid red">
                                                                        <%# Eval("DescrizioneLivello")%></div>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>

                                                            <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" HeaderStyle-Width="20px"
                                                                Text="Seleziona Struttura" ItemStyle-Width="20px" FilterControlAltText="Filter Select column"
