<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false" CodeFile="QualifichePage.aspx.vb" Inherits="QualifichePage" %>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="DescrizioneTextBox" runat="server" Skin="Office2007" 
                            Width="300px" MaxLength="100" ToolTip="Descrizione qualifica" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 90px">
                        <asp:Label ID="OrdinaleLabel" runat="server" CssClass="Etichetta" Text="Ordinale"/>
                    </td>
                    <td>
                       <telerik:RadNumericTextBox ID="OrdinaleTextBox" runat="server" Skin="Office2007" 
                            Width="60px" DataType="System.Int32" MaxLength="4" MaxValue="9999" MinValue="1" 
                            ShowSpinButtons="True" ToolTip="Ordinale qualifica" >
                                            ...
                                            <tr>
                                                <td>
                                                    &nbsp;<asp:Label ID="TitoloElencoLabel" runat="server" Font-Bold="True" Style="width: 800px;
                                                        color: #00156E; background-color: #BFDBFF" Text="Elenco Qualifiche Organigramma" 
                                                        CssClass="Etichetta" />
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow: auto; height: 305px; width: 100%; background-color: #FFFFFF;
                                         ...
                                         <telerik:RadGrid ID="QualificheGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                ...
                                                <MasterTableView DataKeyNames="Id">
                                                    <Columns>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderStyle-Width="730px" ItemStyle-Width="730px" DataField="Nome"
                                                            FilterControlAltText="Filter Nome column" HeaderText="Descrizione" SortExpression="Nome"
                                                            UniqueName="Nome">
                                                            <ItemTemplate>
                                                         ...
                                                         <telerik:GridTemplateColumn HeaderStyle-Width="70px" ItemStyle-Width="70px" DataField="Ordinale"
                                                            FilterControlAltText="Filter Ordinale column" HeaderText="Ordinale" SortExpression="Ordinale"
                                                            UniqueName="Ordinale">
                                                            <ItemTemplate>
                                                        ...
                                                        <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" HeaderStyle-Width="20px"
                                                            ItemStyle-Width="20px" Text="Seleziona Qualifica" FilterControlAltText="Filter Select column"
