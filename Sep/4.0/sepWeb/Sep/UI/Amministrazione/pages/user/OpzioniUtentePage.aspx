<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false" CodeFile="OpzioniUtentePage.aspx.vb" Inherits="OpzioniUtentePage" %>
        ...
        <ContentTemplate>
            ...
            <div id="pageContent">
                <center>
                    ...
                    <asp:ImageButton Style="display: none" ID="RedirectImageButton" runat="server" />
                  
                    <asp:Label ID="MessaggioLabel" Visible="False" runat="Server" Text="Attenzione: la sua password è scaduta e deve essere modificata!"
                        Font-Bold="True" Style="color: #FF0000" />
                        <br />
                                    ...
                                    <tr>
                                        <td style="background-color: #BFDBFF; padding: 0px; border-bottom: 1px solid  #9ABBE8;
                                            ...
                                            &nbsp;<asp:Label ID="TitoloLabel" runat="server" Style="color: #00156E" Font-Bold="True"
                                                Text="Impostazioni Utente" CssClass="Etichetta" />
                                        </td>
                                    </tr>
                                    <%-- BODY--%>
                                    <tr>
                                        <td class="ContainerMargin">
                                            <table class="Container" cellpadding="0" cellspacing="4" width="100%" border="0"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="overflow: auto; height: 110px; width: 100%; background-color: #DFE8F6;
                                                            border: 0px solid #5D8CC9;">
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    <td style="width: 150px">
                                                                        <asp:Label ID="PasswordCorrenteLabel" runat="server" CssClass="Etichetta" Text="Password corrente" />
                                                                    </td>
                                                                    <td>
                                                                        <telerik:RadTextBox ID="PasswordCorrenteTextBox" runat="server" Skin="Office2007"
                                                                            Width="250px" TextMode="Password" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 150px">
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="NuovaPasswordTextBox" runat="server" Skin="Office2007" Width="250px"
                                                                            TextMode="Password" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 150px">
                                                                        <asp:Label ID="ModuloLabel" runat="server" CssClass="Etichetta" Text="Modulo predefinito" />
                                                                    </td>
                                                                    <td>
                                                                        <telerik:RadComboBox ID="ModuloComboBox" runat="server" Skin="Office2007" Width="249px"
