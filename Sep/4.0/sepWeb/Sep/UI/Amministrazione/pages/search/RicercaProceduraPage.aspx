<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaProceduraPage.aspx.vb"
    Inherits="RicercaProceduraPage" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ricerca Procedure</title>
                                        ...
                                        <td>
                                            <div id="scrollPanel" runat="server" style="overflow: auto; height: 500px; width: 100%; background-color: #FFFFFF;
                                                border: 0px solid #5D8CC9;">
                                                  ...
                                                  <telerik:RadGrid ID="ProcedureGridView" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <MasterTableView DataKeyNames="Id">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" FilterControlAltText="Filter Select column"
                                                            ...
                                                            ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" Text="Seleziona Procedura">
