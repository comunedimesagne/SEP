<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaProfiliPage.aspx.vb"
    Inherits="RicercaProfiliPage" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Ricerca Profili</title>
                        ...
                        <tr>
                            <td class="ContainerMargin">
                                <table class="Container" cellpadding="0" cellspacing="4" width="100%" border="0">
                                    <tr>
                                        <td>
                                            <div id="scrollPanel" runat="server" style="overflow: auto; height: 500px; width: 100%;
                                                background-color: #FFFFFF; border: 0px solid #5D8CC9;">
                                                <telerik:RadGrid ID="ProfiliGridView" runat="server" AutoGenerateColumns="False"
                                                    CellSpacing="0" GridLines="None" Skin="Office2007" Width="98%" AllowSorting="True"
                                                    AllowMultiRowSelection="True" AllowFilteringByColumn="True" Culture="it-IT">
                                                    <MasterTableView DataKeyNames="Id">
                                                        <Columns>
                                                            ...
                                                            <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" FilterControlAltText="Filter Select column"
                                                                ...
                                                                ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" Text="Seleziona Profilo">
