<%@ Page Title="" Language="VB" MasterPageFile="~/MainPage.master" AutoEventWireup="false" CodeFile="LetteraTrasmissionePage.aspx.vb" Inherits="LetteraTrasmissionePage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function OnItemChecked(sender, e) {
            var anteprimaStampaButton = $find('<%= StampaLetteraCapigruppoButton.ClientId %>');
            var esportaButton = $find('<%= StampaLetteraRevisoriButton.ClientId %>');
                              ...
                              <%--  HEADER--%>
                                                ...
                                                <tr>
                                                    <td>
                                                        &nbsp;<asp:Label ID="PannelloFiltroLabel" runat="server" Font-Bold="True" Style="color: #00156E;
                                                            background-color: #BFDBFF" Text="Filtro Delibere" />
                                                    </td>
                                   ...
                                   <%-- CONTENT--%>
                                                            ...
                                                            <asp:Panel ID="PubblicazioneWePanel" runat="server">
                                                                <table style="width: 100%">
                                                                    <tr style="height: 25px">
                                                                        ...
                                                                        <td style="padding-left: 1px; padding-right: 1px; width:290px">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    &nbsp;<asp:Label ID="PannelloRisultatiLabel" runat="server" Font-Bold="True" Style="width: 400px;
                                                                                        color: #00156E; background-color: #BFDBFF" Text="Elenco Delibere" />
                                                                                </td>
                                                                                <td style="width: 30px">
                                    ...
                                    border-top: 1px solid  #9ABBE8; height: 25px">
                                            <telerik:RadButton ID="StampaLetteraCapigruppoButton" runat="server" 
                                                Text="Capigruppo" Width="120px"
                                                Skin="Office2007" ToolTip="Effettua la stampa della lettera ai capigruppo">
                                                <Icon PrimaryIconUrl="../../../../images/Printer16.png" PrimaryIconLeft="5px" />
                                            </telerik:RadButton>
                                            &nbsp;
                                            <telerik:RadButton ID="StampaLetteraRevisoriButton" runat="server" 
                                                Text="Revisori" Width="120px"
                                                Skin="Office2007" ToolTip="Effettua la stampa della lettera ai revisori">
                                                <Icon PrimaryIconUrl="../../../../images/Printer16.png" PrimaryIconLeft="5px" />
                                            </telerik:RadButton>
                                        </td>
                                    </tr>
