<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaCapitoloPage.aspx.vb"
    Inherits="RicercaCapitoloPage" %>
                                        ...
                                        <td class="ContainerMargin">
                                            <table class="Container" cellpadding="0" cellspacing="4" width="100%" border="0">
                                                <tr>
                                                        ...
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("NumeroCapitolo")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                        ...
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("Articolo")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                                width: 70px; border: 0px solid red">
                                                                <%# Eval("Articolo")%></div>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                     ...
                                                     <telerik:GridTemplateColumn HeaderStyle-Width="70px" ItemStyle-Width="70px" DataField="DescrizioneTipologiaCapitolo"
                                                        FilterControlAltText="Filter DescrizioneTipologiaCapitolo column" HeaderText="Tipologia" SortExpression="DescrizioneTipologiaCapitolo"
                                                         AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" 
                                                         FilterControlWidth="100%" ShowFilterIcon="False"
                                                        UniqueName="DescrizioneTipologiaCapitolo" AllowFiltering="false">
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("DescrizioneTipologiaCapitolo")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                                width: 70px; border: 0px solid red">
                                                     ...
                                                     <telerik:GridTemplateColumn HeaderStyle-Width="50px" ItemStyle-Width="50px" DataField="Missione"
                                                        FilterControlAltText="Filter Missione column" HeaderText="Miss." SortExpression="Missione"
                                                         AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" 
                                                         FilterControlWidth="100%" ShowFilterIcon="False"
                                                        UniqueName="Missione" AllowFiltering="true">
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("Missione")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                       ...
                                                       <telerik:GridTemplateColumn HeaderStyle-Width="50px" ItemStyle-Width="50px" DataField="Programma"
                                                        FilterControlAltText="Filter Programma column" HeaderText="Prog." SortExpression="Programma"
                                                         AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" 
                                                         FilterControlWidth="100%" ShowFilterIcon="False"
                                                        UniqueName="Programma" AllowFiltering="true">
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("Programma")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                                width: 50px; border: 0px solid red">
                                                                <%# Eval("Programma")%></div>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                        ...
                                                        FilterControlAltText="Filter MacroAggregato column" HeaderText="M. Aggr." SortExpression="MacroAggregato"
                                                         AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" 
                                                         FilterControlWidth="100%" ShowFilterIcon="False"
                                                        UniqueName="MacroAggregato" AllowFiltering="true">
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("MacroAggregato")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                                width: 70px; border: 0px solid red">
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderStyle-Width="200px" ItemStyle-Width="200px" DataField="Struttura"
                                                        FilterControlAltText="Filter Struttura column" HeaderText="Struttura" SortExpression="Struttura"
                                                         AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" 
                                                    FilterControlWidth="100%" ShowFilterIcon="False"
                                                        UniqueName="Struttura">
                                                        <ItemTemplate>
                                                            <div title='<%# Eval("Struttura")%>' style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
                                                                width: 200px;border: 0px solid red">
                                                                <%# Eval("Struttura")%></div>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
