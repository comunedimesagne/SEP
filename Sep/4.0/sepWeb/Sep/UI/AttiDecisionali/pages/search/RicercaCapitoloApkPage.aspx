<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaCapitoloApkPage.aspx.vb"
    Inherits="RicercaCapitoloApkPage" %>
                                                                            ...
                                                                            <MasterTableView DataKeyNames="Id">
                                                                                <Columns>
                                                                                   ...
                                                                                   <%-- <telerik:GridTemplateColumn HeaderStyle-Width="50px" ItemStyle-Width="50px" DataField="DescrizioneTipologiaCapitolo"
                                                                                    ...
                                                                                    <telerik:GridTemplateColumn HeaderStyle-Width="200px" ItemStyle-Width="200px" DataField="CapitoloDescrizione"
                                                                                        FilterControlAltText="Filter CapitoloDescrizione column" HeaderText="Descrizione" SortExpression="CapitoloDescrizione"
                                                                                        AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" FilterControlWidth="100%"
                                                                                        ShowFilterIcon="False" UniqueName="CapitoloDescrizione">
                                                                                        <ItemTemplate>
                                                                                            <div title='<%# Eval("CapitoloDescrizione")%>' style="white-space: nowrap; overflow: hidden;
                                                                                                text-overflow: ellipsis; width: 200px; border: 0px solid red">
                                                                                                <%# Eval("CapitoloDescrizione")%></div>
                                                                                        </ItemTemplate>
                                                                                    </telerik:GridTemplateColumn>

                                                                                    <telerik:GridTemplateColumn HeaderStyle-Width="200px" ItemStyle-Width="200px" DataField="ServizioDescrizione"
                                                                                        FilterControlAltText="Filter ServizioDescrizione column" HeaderText="Struttura"
                                                                                        SortExpression="ServizioDescrizione" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains"
                                                                                        FilterControlWidth="100%" ShowFilterIcon="False" UniqueName="ServizioDescrizione">
                                                                                        <ItemTemplate>
                                                                                            <div title='<%# Eval("ServizioDescrizione")%>' style="white-space: nowrap; overflow: hidden;
                                                                                                text-overflow: ellipsis; width: 200px; border: 0px solid red">
                                                                                                <%# Eval("ServizioDescrizione")%></div>
                                                                                        </ItemTemplate>
                                                                                    </telerik:GridTemplateColumn>
