<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaImpegnoDedaGroupPage.aspx.vb"
    Inherits="RicercaImpegnoDedaGroupPage" %>
                                                         ...
                                                         <td>
                                                                    <div style="overflow: auto; height: 360px; width: 100%; background-color: #FFFFFF;
                                                                        ...
                                                                        <telerik:RadGrid ID="ImpegniGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                            ...
                                                                            <MasterTableView DataKeyNames="IdImpegno">
                                                                                <Columns>


                                                                                    <telerik:GridBoundColumn DataField="IdImpegno" DataType="System.Int32" FilterControlAltText="Filter IdImpegno column"
                                                                                        HeaderText="Id" Visible="false" SortExpression="IdImpegno" UniqueName="IdImpegno" />
                                                                                      ...
                                                                                      <telerik:GridTemplateColumn HeaderStyle-Width="70px" ItemStyle-Width="70px" DataField="NumeroCapitolo"
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <div title='Id Capitolo: <%# Eval("IdCapitolo")%>' style="white-space: nowrap; overflow: hidden;
                                                                                                text-overflow: ellipsis; width: 70px; border: 0px solid red">
                                                                                                <%# Eval("NumeroCapitolo")%></div>
                                                                                        </ItemTemplate>
                                                                                    </telerik:GridTemplateColumn>

                                                                                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" ItemStyle-Width="70px" DataField="NumeroArticolo"
                                                                                        FilterControlAltText="Filter NumeroArticolo column" HeaderText="Articolo" SortExpression="NumeroArticolo"
                                                                                        AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" FilterControlWidth="100%"
                                                                                        ShowFilterIcon="False" UniqueName="NumeroArticolo">
                                                                                        <FilterTemplate>
                                                                                            <telerik:RadNumericTextBox Width="100%" ID="ArticoloTextBox" runat="server" DbValue='<%# TryCast(Container, GridItem).OwnerTableView.GetColumn("NumeroArticolo").CurrentFilterValue %>'
                                                                                                ...
                                                                                                <script type="text/javascript">
                                                                                                    function OnArticoloTextBoxKeyPressed(sender, args) {
                                                                                                        if (13 == args.get_keyCode()) {
                                                                                                            var tableView = $find("<%# CType(Container,GridItem).OwnerTableView.ClientID %>");
                                                                                                            var c = sender.get_textBoxValue();
                                                                                                            tableView.filter("NumeroArticolo", c, "EqualTo");
                                                                                                            args.set_cancel(true);
                                                                                                        }
                                                                                                        var text = sender.get_value() + args.get_keyCharacter();
                                                                                                        if (!text.match('^[0-9]+$'))
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <div title='<%# Eval("NumeroArticolo")%>' style="white-space: nowrap; overflow: hidden;
                                                                                                text-overflow: ellipsis; width: 70px; border: 0px solid red">
                                                                                                <%# Eval("NumeroArticolo")%></div>
                                                                                        </ItemTemplate>
                                                                                    </telerik:GridTemplateColumn>
