<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RicercaRuoloPage.aspx.vb" Inherits="RicercaRuoloPage" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>


<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ricerca Ruolo</title>
                                        ...
                                        <td>
                                            <div id="scrollPanel" runat="server" style="overflow: auto; height: 500px; width: 100%; background-color: #FFFFFF;
                                                border: 0px solid #5D8CC9;">
                                                     ...
                                                     <telerik:RadGrid ID="RuoliGridView" runat="server"  
                                          AutoGenerateColumns="False" CellSpacing="0"  GridLines="None" Skin="Office2007" 
                                          Width="98%" AllowSorting="True" AllowMultiRowSelection="True" 
                        ...
                        <MasterTableView DataKeyNames="Id">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Id" DataType="System.Int32" FilterControlAltText="Filter Id column"
                                    ...
                                    ItemStyle-Width="45px" HeaderStyle-Width="45px" Visible="false">
                                ...
                                <telerik:GridBoundColumn DataField="Descrizione" FilterControlAltText="Filter Descrizione column"
                                    ...
                                    ShowFilterIcon="False" ItemStyle-Width="550px" HeaderStyle-Width="550px">
                                </telerik:GridBoundColumn>
